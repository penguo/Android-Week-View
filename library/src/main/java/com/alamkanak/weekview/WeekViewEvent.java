...
public class WeekViewEvent {
    ...
    public List<WeekViewEvent> splitWeekViewEvents() {
        ...
        if (!isSameDay(this.getStartTime(), endTime)) {
            ...
            Calendar lastTime = (Calendar) this.getEndTime().clone();
            lastTime.add(Calendar.MILLISECOND, -1);
            while (!isSameDay(otherDay, lastTime)) {
                ...
                WeekViewEvent eventMore = new WeekViewEvent(this.getId(), this.getName(), this.getLocation(), overDay, endOfOverDay, this.isAllDay());
            ...
            // Add last day.
            Calendar startTime = (Calendar) lastTime.clone();
            startTime.set(Calendar.HOUR_OF_DAY, 0);
            startTime.set(Calendar.MINUTE, 0);
            WeekViewEvent event2 = new WeekViewEvent(this.getId(), this.getName(), this.getLocation(), startTime, lastTime, this.isAllDay());
